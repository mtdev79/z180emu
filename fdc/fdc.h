...
typedef void (*devcb_write_line)(void *device, int state);
...
typedef struct {
	...
	devcb_write_line int_state_cb;
	devcb_write_line dma_req_cb;
...
extern void fdc_dma_ack(fdc_t *fdc);
...
void fdc_close(void *priv);
fdc_t *fdc_init(uint32_t flags, devcb_write_line int_state_cb, devcb_write_line dma_req_cb);

extern uint8_t	fdc_ps1_525(void);

#ifdef EMU_DEVICE_H
extern const fdc_type_t	fdc_xt_device;
extern const fdc_type_t	fdc_xt_t1x00_device;
extern const fdc_type_t	fdc_pcjr_device;
extern const fdc_type_t	fdc_at_device;
extern const fdc_type_t	fdc_at_actlow_device;
extern const fdc_type_t	fdc_at_ps1_device;
extern const fdc_type_t	fdc_at_smc_device;
extern const fdc_type_t	fdc_at_winbond_device;
extern const fdc_type_t	fdc_at_nsc_device;
#endif
