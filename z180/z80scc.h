...
/*private:
	...
	enum
	{
		Z80SCC_INT_TRANSMIT            = 0,
		Z80SCC_INT_EXTERNAL            = 1,
		Z80SCC_INT_RECEIVE             = 2,
		Z80SCC_INT_SPECIAL             = 3,
	};

	enum
	{
		Z80SCC_INT_TRANSMIT_PRIO       = 1,
		Z80SCC_INT_EXTERNAL_PRIO       = 0,
		Z80SCC_INT_RECEIVE_PRIO        = 2,
		Z80SCC_INT_SPECIAL_PRIO        = 0,
	};
...
protected:
	z80scc_device(const machine_config &mconfig, device_type type, const char *tag, device_t *owner, uint32_t clock);
...
*/
	...
	struct z80scc_channel *m_chanA;
	struct z80scc_channel *m_chanB;
...
struct z80scc_device *z80scc_device_create(void *owner, char *tag, UINT32 type, UINT32 clock,
	...
	rx_callback_t rx_callback,tx_callback_t tx_callback /* only on Z182 */);
