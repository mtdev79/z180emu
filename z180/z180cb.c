...
OP(cb,30) { /*cpustate->_B = SLL(cpustate, cpustate->_B);*/illegal_2(cpustate);                                         } /* SLL  B           */
OP(cb,31) { /*cpustate->_C = SLL(cpustate, cpustate->_C);*/illegal_2(cpustate);                                         } /* SLL  C           */
OP(cb,32) { /*cpustate->_D = SLL(cpustate, cpustate->_D);*/illegal_2(cpustate);                                         } /* SLL  D           */
OP(cb,33) { /*cpustate->_E = SLL(cpustate, cpustate->_E);*/illegal_2(cpustate);                                         } /* SLL  E           */
OP(cb,34) { /*cpustate->_H = SLL(cpustate, cpustate->_H);*/illegal_2(cpustate);                                         } /* SLL  H           */
OP(cb,35) { /*cpustate->_L = SLL(cpustate, cpustate->_L);*/illegal_2(cpustate);                                         } /* SLL  L           */
OP(cb,36) { /*WM(cpustate,  cpustate->_HL, SLL(cpustate, RM(cpustate, cpustate->_HL)) );*/illegal_2(cpustate);                              } /* SLL  (HL)        */
OP(cb,37) { /*cpustate->_A = SLL(cpustate, cpustate->_A);*/illegal_2(cpustate);                                         } /* SLL  A           */
