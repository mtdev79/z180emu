...
rtc_markiv.o: ds1202_1302/rtc.c ds1202_1302/rtc.h
	cd ds1202_1302 ; $(CC) -Dmachine_name=\"markiv\" -DHAVE_SYS_TIME_H -DHAVE_GETTIMEOFDAY -o ../rtc_markiv.o -c rtc.c 
